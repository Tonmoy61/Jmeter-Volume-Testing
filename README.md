...
:black_nib: Database is tested by **100 users** concurrently reading info in **60s**.
...
:black_nib: The users are increased more and local database is tested for **300 users** reading info in **60s**.
...
:black_nib: Database is tested by **180 users** concurrently reading info in **60s**.
