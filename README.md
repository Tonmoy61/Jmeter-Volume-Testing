...
:hash: JDBC connection is configured by connecting a specific Database where there is pre-existing datas.
:hash: JDBC driver class "com.mysql.jdbc.Driver" is configured.
:hash: mysql-connector-java is put in the lib folder of apache-jmeter.
