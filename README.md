...
➡️JDBC connection is configured by connecting a specific Database where there is pre-existing datas
➡️JDBC driver class "com.mysql.jdbc.Driver" is configured
➡️mysql-connector-java is put in the lib folder of apache-jmeter
